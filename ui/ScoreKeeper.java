...
public class ScoreKeeper extends Application{
    ...
    public void start(Stage primaryStage){
        ...
        startGameButton.setOnAction(e -> {
            ...
            eventlog.appendText("model.Game started: "+ game.getHomeTeam() + " vs "+ game.getAwayTeam() + "\n");
        ...
        addScoreHome.setOnAction(e -> {
           ...
           eventlog.appendText("Home model.Team scored 2 points. \n");
        });
        ...
        primaryStage.setTitle("ui.ScoreKeeper");
        primaryStage.show();
